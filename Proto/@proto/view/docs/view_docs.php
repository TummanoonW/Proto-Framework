          ...
          <div class="container mt-4">
            ...
            <div class="pt-3 pb-2">
              ...
              <div class="container mt-4">
                ...
                <a href="hhttps://www.dropbox.com/s/zxdnoi2o2dt7mnx/proto-empty.zip?dl=1" target="_blank" class="btn btn-outline-primary mr-2">
              ...
              <div class="container mt-4">
                ...
                <div class="p-4 rounded bg-dark">
                  <code class="text-warning">
                    ...
                    <br><span class="pl-2">App::include_view($dir, 'view_mypage.php'); </span>
                    <br>
