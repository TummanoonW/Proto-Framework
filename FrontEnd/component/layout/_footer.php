                    ...
                    <footer class="margin-top text-muted bg-light">
                      <div class="container-fluid p-2 p-md-4">
                        <ul class="nav">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" href="<?php Nav::printURL($dir, App::$pageAbout) ?>">About</a>
                          </li>
                        </ul>

                        <div class="p1 p-md-3">
                            <p>Designed and built by <a href="<?php Nav::printURL($dir, App::$pageAbout) ?>">Tummanoon Wancha-em</a> with the help of <a href="https://github.com/TummanoonW/Proto-Framework/graphs/contributors" target="_blank">our contributors</a>.</p>
