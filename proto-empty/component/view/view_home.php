...
?>
            ...
            <div class="jumbotron bg-light padding-top">
                ...
                <a class="btn btn-outline-primary btn-lg" href="http://trialation.com/proto-framework/pages/get-start/" target="_blank" role="button">Get Start</a>
                &nbsp;
                <a class="btn btn-outline-success btn-lg" target="_blank" href="https://www.trialation.com/proto-framework" role="button">Visit Website</a>
                <hr class="my-4">
